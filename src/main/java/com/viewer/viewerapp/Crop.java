...
public class Crop {
    ...
    private static Stage createCropStage(ImageView imageView, Artboard artboard) {
        ...
        cropStage.setTitle("Image Cropping");
    ...
    private static Pane createInputPane(Artboard artboard, Stage cropStage, ImageView originalImageView, Rectangle cropRectangle, List<Rectangle> handles) {
        ...
        inputPane.setMaxWidth(originalImageView.getFitWidth());
        inputPane.setPadding(new Insets(10));
        inputPane.setSpacing(20);
        inputPane.setAlignment(Pos.CENTER);

        HBox axesPanes = new HBox(20);
        axesPanes.setAlignment(Pos.CENTER);

        VBox xAxisFields = new VBox(5);
        Label xAxisLabel = new Label("X axis");
        xAxisLabel.setStyle("-fx-font-weight: bold;");
        ...
        xAxisFields.getChildren().addAll(xAxisLabel, xStartField, xEndField);

        VBox yAxisFields = new VBox(5);
        ...
        yAxisFields.getChildren().addAll(yAxisLabel, yStartField, yEndField);
        ...
        axesPanes.getChildren().addAll(xAxisFields, yAxisFields);
